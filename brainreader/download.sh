...
HOST="https://portal.nersc.gov/project/crcns/download/"

curl -s -C - -c cookie.txt -d username=jteeters -d password=612crc212 -d fn=hc3 -d submit=Login \
   https://portal.nersc.gov/project/crcns/download/index.php > /dev/null


# https://portal.nersc.gov/project/crcns/download/tds/file1.txt
